...
type PluralCardProps = {
  singular: string;
  plural: string;
};

export function createPluralCard({
  singular,
  plural,
}: PluralCardProps) {
  ...
  drawSection(230, "Singular", singular, "#ff9f5a", "#a066ff");
  drawSection(490, "Plural", plural, "#6b8cff", "#4fd1c5");
